...
class HuggingFaceImageGenerator:
    def __init__(self, api_token=None):
        ...
        self.img2img_models = {
            ...
            "kandinsky_img2img": "kandinsky-community/kandinsky-2-2-decoder",
            "flux_schnell": "black-forest-labs/FLUX.1-schnell"
        }
        
        self.default_model = self.models["flux_schnell"]  # Faster model for free tier
        self.default_img2img_model = self.img2img_models["instruct_pix2pix"]  # Reliable instruction-based editing
